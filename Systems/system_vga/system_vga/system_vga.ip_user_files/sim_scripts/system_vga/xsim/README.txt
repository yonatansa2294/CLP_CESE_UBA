...
#
# Generated by export_simulation on Thu Aug 24 16:45:23 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './system_vga.sh' script.

./system_vga.sh -reset_run
...
./system_vga.sh -noclean_files

For more information on the script, please type './system_vga.sh -help'.
