...
HD_PWD='C:/FPGA/MyS/Systems/system_vga/system_vga/system_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_vga_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_vga_wrapper.tcl -notrace
