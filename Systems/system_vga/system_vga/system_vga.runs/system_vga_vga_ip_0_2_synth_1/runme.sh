...
HD_PWD='C:/FPGA/MyS/Systems/system_vga/system_vga/system_vga.runs/system_vga_vga_ip_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_vga_vga_ip_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_vga_vga_ip_0_2.tcl
