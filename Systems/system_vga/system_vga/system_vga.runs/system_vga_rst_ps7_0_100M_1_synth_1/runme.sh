...
HD_PWD='C:/FPGA/MyS/Systems/system_vga/system_vga/system_vga.runs/system_vga_rst_ps7_0_100M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_vga_rst_ps7_0_100M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_vga_rst_ps7_0_100M_1.tcl
