...
HD_PWD='C:/FPGA/Codigos/VGA/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_vga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_vga.tcl -notrace
