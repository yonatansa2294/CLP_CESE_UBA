...
HD_PWD='C:/FPGA/Codigos/VGA/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_vga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_vga.tcl
